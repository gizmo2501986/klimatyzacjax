                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action=" {{ route('section_five_square_one_insert')  }} " enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Opis</h4>
                                                ...
                                                <textarea class="form-control"  name="opis" id="exampleFormControlTextarea1">  {{ (!empty($section_one_square_one->opis)? $section_one_square_one->opis: '') }} </textarea>
