                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action=" {{ route('section_two_klienci_text_edit_update')  }}  "
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <textarea class="form-control" name="text_2"  > {{ !empty($section_two_edit->text_2) ? $section_two_edit->text_2 : '' }} </textarea>
